      ...
      child: Row(
        children: [
          _CircleIconButton(
            ...
            onTap: () {
              // u tab-nav kontekstu nema back; ostavi no-op ili otvori drugi stack
            },
          ),
          const Spacer(),
          Text(
...
class _StatsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.cardColor, // ⬅️ card po temi
...
class _DividerY extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color: theme.dividerColor, // ⬅️ divider po temi
    );
  }
}
